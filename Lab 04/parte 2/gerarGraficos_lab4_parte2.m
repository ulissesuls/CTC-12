str_ini = "SSP_Tests_";
str_meio = "AlunoTimed1_"; % "Timed_"; (Alterar dependendo de qual gerador)
algs = ["DD","A2","PD","EX"]; % Coloque os algoritmos que vc botou no Tests_Aluno
gers = ["TODD","P3","P6","RAND", "EVOD","AVIS"]; %Coloque os geradores de instancia
str_fim = ".dat";

for i = 1:size(algs,2)
    for j = 1:size(gers,2)
        path = str_ini + str_meio + algs(i) +"_" +  gers(j) + str_fim;
